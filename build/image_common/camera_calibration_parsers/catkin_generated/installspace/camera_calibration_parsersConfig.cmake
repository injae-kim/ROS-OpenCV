...
if("FALSE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/helios789/catkin_ws/src/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX /home/helios789/catkin_ws/devel)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/helios789/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/helios789/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND camera_calibration_parsers_EXPORTED_TARGETS ${${camera_calibration_parsers_dep}_EXPORTED_TARGETS})
endforeach()
